...
export function AdmissionDeleteDialog({ admissionId, patientName, onPatientDeleted, trigger}: PatientDeleteDialogProps) {
  ...
  const handleDelete = async () => {
    try {
      ...
      const { error } = await supabase.from("Admissions").delete().eq("admission_id", admissionId)
